...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { code: @grade.code, course: @grade.course, grade: @grade.grade, points: @grade.points } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { code: @grade.code, course: @grade.course, grade: @grade.grade, points: @grade.points } }
